...
public class MissionariesAndCannibals {
    ...
    public static boolean MissTwo(int[] list, String boat, boolean[] visited) {
        ...
        // opposite bank
        if (boat.equals("Left Bank") && visited[0] == false) {
            list[2] += 2;
            list[0] -= 2;
            visited[1] = true;
            return true;
        } else if (boat.equals("Right Bank") && visited[1] == false) {
            list[2] -= 2;
            list[0] += 2;
            visited[0] = true;
            return true;
    ...
    public static boolean CanTwo(int[] list, String boat, boolean[] visited) {
        // These conditions check the bank status and then updates their location to
        // opposite bank
        if (boat.equals("Left Bank") && visited[2] == false) {
            list[3] += 2;
            list[1] -= 2;
            visited[3] = true;
            return true;
        } else if (boat.equals("Right Bank") && visited[3] == false) {
            list[3] -= 2;
            list[1] += 2;
            visited[2] = true;
            return true;
    ...
    public static boolean MissOne(int[] arr, String boat, boolean[] alrdyVisited) {
        // These conditions check the bank status and then updates their location to
        // opposite bank
        if (boat.equals("Left Bank") && alrdyVisited[4] == false) {
            arr[2] += 1;
            arr[0] -= 1;
            alrdyVisited[5] = true;
            return true;
        } else if (boat.equals("Right Bank") && alrdyVisited[5] == false) {
            arr[2] -= 1;
            arr[0] += 1;
            alrdyVisited[4] = true;
            return true;
    ...
    public static boolean CanOne(int[] arr, String boat, boolean[] visited) {
        // These conditions check the bank status and then updates their location to
        // opposite bank
        if (boat.equals("Left Bank") && visited[6] == false) {
            arr[3] += 1;
            arr[1] -= 1;
            visited[7] = true;
            return true;
        } else if (boat.equals("Right Bank") && visited[7] == false) {
            arr[3] -= 1;
            arr[1] += 1;
            visited[6] = true;
            return true;
    ...
    public static boolean MissOneCanOne(int[] arr, String boat, boolean[] visited) {
        // These conditions check the bank status and then updates their location to
        // opposite bank
        if (boat.equals("Left Bank") && visited[8] == false) {
            arr[2] += 1;
            arr[0] -= 1;
            arr[3] += 1;
            arr[1] -= 1;
            visited[9] = true;
            return true;
        } else if (boat.equals("Right Bank") && visited[9] == false) {
            arr[2] -= 1;
            arr[0] += 1;
            arr[3] -= 1;
            arr[1] += 1;
    ...
    public static void MC(int[] list, String boat, boolean[] visited) {
        ...
        if ((list[0] - 2 > list[1] || list[0] - 2 == 0) && boat.equals("Left Bank")) {
        ...
        if (list[1] - 2 >= 0 && boat.equals("Left Bank")) {
        ...
        if ((list[0] - 1 > list[1] || list[0] - 1 == 0) && boat.equals("Left Bank")) {
        ...
        // C should be either 0 or greater than zero at this bank
        if (list[1] - 1 >= 0 && boat.equals("Left Bank")) {
        ...
        if (list[0] == list[1] && boat.equals("Left Bank")) {
        ...
        if ((list[2] - 2 > list[3] || list[2] - 2 == 0) && boat.equals("Right Bank")) {
            if (MissTwo(list, boat, visited)) {
                System.out.println("Boat Status: (M M)\n");
                boat = "Left Bank";
                MC(list, boat, visited);
        ...
        // C should be either 0 or greater than zero at this bank
        if (list[3] - 2 >= 0 && boat.equals("Right Bank")) {
            if (CanTwo(list, boat, visited)) {
                System.out.println("Boat Status: (C C)\n");
                boat = "Left Bank";
                MC(list, boat, visited);
        ...
        // M should be either 0 or greater than number of cannibals at this bank
        if ((list[2] - 1 > list[3] || list[2] - 1 == 0) && boat.equals("Right Bank")) {
            if (MissOne(list, boat, visited)) {
                System.out.println("Boat Status: (M _)\n");
                boat = "Left Bank";
                MC(list, boat, visited);
        ...
        // C should be either 0 or greater than zero at this bank
        if (list[3] - 1 >= 0 && boat.equals("Right Bank")) {
            if (CanOne(list, boat, visited)) {
                System.out.println("Boat Status: (C _)\n");
                boat = "Left Bank";
                MC(list, boat, visited);
        ...
        // C and M should be equal in number at this bank
        if (list[2] == list[3] && boat.equals("Right Bank")) {
            if (MissOneCanOne(list, boat, visited)) {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Enter the number Missionaries: ");
